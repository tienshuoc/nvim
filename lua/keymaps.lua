...
-- ========================================================= Visual mode ===============================================================
----------------------------------------------------------------------------------------------------------------------------------------
vim.keymap.set('v', '<Up>', ":m '>+1<CR>gv=gv", opts)  -- For Colemak layout. This might ruin existing prev-word motion, but don't really use that for line visuals anyways.
vim.keymap.set('v', '<Down>', ":m '<-2<CR>gv=gv", opts)  -- For Colemak layout. This might ruin existing prev-end-of-word motion, but don't really use that for line visuals anyways.
